...
class OweToContactList extends StatefulWidget {
  ...
  @override
  _OweToContactListState createState() => _OweToContactListState();
}

class _OweToContactListState extends State<OweToContactList> {
  ...
  void _navigateToNextScreen() {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => IOweToScreen(selectedContacts: _selectedContacts),
      ),
    );
  }
